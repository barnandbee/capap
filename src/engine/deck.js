/* Capitalist Apocalypse — deck building (DOM-free engine module). */
import { ACTIONS, HP, ORGS } from "./data.js";

let UID = 1;
export function mkAction(a){return {cat:"Action",type:"Action",name:a[0],text:a[1],qty:a[2]};}
export function mkHP(h){return {cat:"Higher Power",type:"Higher Power",name:h[0],text:h[1]};}
export function mkOrg(o){return {cat:"Organisation",type:o[1],name:o[0],sizeIdx:o[2],values:o[3],merge:o[4],usp:o[5]};}
